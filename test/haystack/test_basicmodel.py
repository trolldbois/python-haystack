...
class TestRealSSH(unittest.TestCase):
    ...
    def test_real_life(self):
        ...
        self.assertEquals(send_cipher_ssh.getName(self.memory_handler), 'aes128-ctr')
