...
locale_t = __locale_t
__all__ = ['__uint16_t', '__pthread_mutex_s', 'test3', '__int16_t',
           ...
           '__loff_t', 'intptr_t', 'N14pthread_cond_t4DOT_18E',
           'daddr_t', '_G_uint32_t', 'cookie_seek_function_t',
           'u_char', 'fpos64_t', 'uid_t', 'cookie_write_function_t',
           'u_int64_t', 'u_int16_t', '__time_t', 'sigset_t',
           '_G_fpos64_t', 'blksize_t', 'va_list', '_IO_jump_t',
           '__int32_t', 'fd_mask', '__nlink_t', '__compar_fn_t',
           '__swblk_t', 'cookie_close_function_t', '__uint64_t',
           'FILE', '__ssize_t', '__io_close_fn', 'comparison_fn_t',
           ...
           'Lmid_t', 'obstack', 'N11__mbstate_t3DOT_2E',
           '__locale_struct', '__daddr_t', 'ino64_t',
           '_IO_cookie_file', '__caddr_t', '__mbstate_t',
