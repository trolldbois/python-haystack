...
class Ui_Search_Structure(object):
    def setupUi(self, Search_Structure):
        ...
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(2, 0, 371, 161))
        ...
        self.checkBox_file = QtGui.QCheckBox(self.gridLayoutWidget_2)
        self.checkBox_file.setObjectName(_fromUtf8("checkBox_file"))
        self.gridLayout_4.addWidget(self.checkBox_file, 2, 0, 1, 1)
        self.checkBox_utf8 = QtGui.QCheckBox(self.gridLayoutWidget_2)
        self.checkBox_utf8.setObjectName(_fromUtf8("checkBox_utf8"))
        self.gridLayout_4.addWidget(self.checkBox_utf8, 3, 0, 1, 1)
        ...
        self.toolButton_file = QtGui.QToolButton(self.gridLayoutWidget_2)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.ToolTipText, brush)
        self.toolButton_file.setPalette(palette)
        self.toolButton_file.setAutoFillBackground(True)
        self.toolButton_file.setText(_fromUtf8(""))
        self.toolButton_file.setObjectName(_fromUtf8("toolButton_file"))
        self.gridLayout_4.addWidget(self.toolButton_file, 2, 1, 1, 1)
        self.toolButton_utf8 = QtGui.QToolButton(self.gridLayoutWidget_2)
        palette = QtGui.QPalette()
        brush = QtGui.QBrush(QtGui.QColor(0, 0, 0))
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Active, QtGui.QPalette.WindowText, brush)
        ...
        brush.setStyle(QtCore.Qt.SolidPattern)
        palette.setBrush(QtGui.QPalette.Disabled, QtGui.QPalette.ToolTipText, brush)
        self.toolButton_utf8.setPalette(palette)
        self.toolButton_utf8.setAutoFillBackground(True)
        self.toolButton_utf8.setText(_fromUtf8(""))
        self.toolButton_utf8.setObjectName(_fromUtf8("toolButton_utf8"))
        self.gridLayout_4.addWidget(self.toolButton_utf8, 3, 1, 1, 1)
    ...
    def retranslateUi(self, Search_Structure):
        ...
        self.checkBox_file.setText(QtGui.QApplication.translate("Search_Structure", "Filenames", None, QtGui.QApplication.UnicodeUTF8))
        self.checkBox_utf8.setText(QtGui.QApplication.translate("Search_Structure", "UTF8 Strings", None, QtGui.QApplication.UnicodeUTF8))
