...
class union_c__S__HEAP_LOCK_U_Win7SP1X86DOT_00003BADOT32DOTh_23930(ctypes.Union):
    pass
...
union_c__S__HEAP_LOCK_U_Win7SP1X86DOT_00003BADOT32DOTh_23930._pack_ = True # source:False
union_c__S__HEAP_LOCK_U_Win7SP1X86DOT_00003BADOT32DOTh_23930._fields_ = [
    ('CriticalSection', RTL_CRITICAL_SECTION),
]

struct__HEAP_LOCK._pack_ = True # source:True
struct__HEAP_LOCK._fields_ = [
    ('Lock', union_c__S__HEAP_LOCK_U_Win7SP1X86DOT_00003BADOT32DOTh_23930),
]
...
struct_c__U__SLIST_HEADER_Sa_1._pack_ = True # source:False
struct_c__U__SLIST_HEADER_Sa_1._fields_ = [
...
class union_c__S__HEAP_LOCK_U_Win7SP1X86DOT_000160EDOT32DOTh_19673(ctypes.Union):
    _pack_ = True # source:False
    _fields_ = [
    ('CriticalSection', RTL_CRITICAL_SECTION),
     ]
...
__all__ = \
    ...
    'union_c__S__HEAP_LOCK_U_Win7SP1X86DOT_000160EDOT32DOTh_19673',
    'PHEAP_LOCK', 'PPVOID', 'struct__HEAP_UCR_DESCRIPTOR',
    'LFH_BLOCK_ZONE', 'PVOID32', 'struct__HEAP_LIST_LOOKUP',
    'PSINGLE_LIST_ENTRY', 'struct__HEAP_ENTRY_EXTRA', 'UINT16',
    'PPHEAP_LOOKASIDE', 'PHEAP_BUCKET_RUN_INFO',
    ...
    'struct_c__S__HEAP_FREE_ENTRY_Ua_Sa_4',
    ...
    'struct_c__U__SLIST_HEADER_Sa_1', 'PHEAP_BUCKET', 'USHORT',
    'HEAP_ENTRY_EXTRA', 'union_c__S__HEAP_ENTRY_Ua_Sa_Ua_2',
    'HEAP_PSEUDO_TAG_ENTRY', 'PPHEAP', 'HEAP_LOCK',
    'union_c__S__HEAP_LOCK_U_Win7SP1X86DOT_00003BADOT32DOTh_23930',
    ...
    'PHEAP_SUBSEGMENT', 'HEAP_UCR_DESCRIPTOR',
