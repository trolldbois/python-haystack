...
struct_c__S__HEAP_USERDATA_HEADER_Ua_Sa_1._pack_ = True # source:False
struct_c__S__HEAP_USERDATA_HEADER_Ua_Sa_1._fields_ = [
...
struct__HEAP_LOCK._fields_ = [
    ('Lock', union_c__S__HEAP_LOCK_U_Win7SP1X86DOT_000160EDOT32DOTh_19673),
]
...
__all__ = \
    ...
    'PHEAP_LOCK', 'union__HEAP_BUCKET_RUN_INFO', 'LFH_BLOCK_ZONE',
    ...
    'PUSHORT', 'LFH_HEAP', 'union_c__S__HEAP_ENTRY_Ua_0',
    ...
    'struct__LFH_HEAP', 'HEAP_USERDATA_HEADER',
    'HEAP_PSEUDO_TAG_ENTRY', 'HEAP_LOOKASIDE',
    ...
    'HEAP_LOCAL_SEGMENT_INFO', 'struct__HEAP_LOCAL_SEGMENT_INFO',
    'HEAP_SEGMENT', 'PPVOID', 'HEAP_COUNTERS', 'PULONG',
    'struct__HEAP_LOCAL_DATA', 'WCHAR', 'PHEAP_ENTRY',
    'HEAP_LIST_LOOKUP', 'struct__RTL_CRITICAL_SECTION', 'HEAP',
    'struct_c__S__HEAP_FREE_ENTRY_Ua_Sa_2', 'CHAR', 'LONG',
    'PULONGLONG', 'PLFH_BLOCK_ZONE', 'PPSINGLE_LIST_ENTRY',
    ...
    'struct__HEAP_TAG_ENTRY', 'PSHORT', 'PPHEAP_BUCKET',
