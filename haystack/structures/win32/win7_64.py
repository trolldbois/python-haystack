...
class struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT64DOTh_5141(ctypes.Structure):
    pass

class struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT64DOTh_5141_Sa_0(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
...
struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT64DOTh_5141._pack_ = True # source:False
...
class struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT64DOTh_4753_Sa_0(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
    ('Depth', ctypes.c_uint16, 16),
...
struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT64DOTh_4753._pack_ = True # source:False
...
class struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT64DOTh_4952_Sa_0(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
    ('Depth', ctypes.c_uint16, 16),
    ('Sequence', ctypes.c_uint64, 48),
...
struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT64DOTh_4952._pack_ = True # source:False
