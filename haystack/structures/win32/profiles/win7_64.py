...
class union_c__S__HEAP_LOCK_U_Win7SP1X64DOT0000BEBDOT64DOTh_22559(ctypes.Union):
    pass
...
union_c__S__HEAP_LOCK_U_Win7SP1X64DOT0000BEBDOT64DOTh_22559._pack_ = True # source:False
union_c__S__HEAP_LOCK_U_Win7SP1X64DOT0000BEBDOT64DOTh_22559._fields_ = [
    ('CriticalSection', RTL_CRITICAL_SECTION),
]

struct__HEAP_LOCK._pack_ = True # source:True
struct__HEAP_LOCK._fields_ = [
    ('Lock', union_c__S__HEAP_LOCK_U_Win7SP1X64DOT0000BEBDOT64DOTh_22559),
]
...
struct_c__S__HEAP_ENTRY_Ua_Sa_2._pack_ = True # source:False
struct_c__S__HEAP_ENTRY_Ua_Sa_2._fields_ = [
...
class struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT0000BEBDOT64DOTh_11515(ctypes.Structure):
    pass

class struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT0000BEBDOT64DOTh_11515_Sa_0(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
...
struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT0000BEBDOT64DOTh_11515._pack_ = True # source:False
struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT0000BEBDOT64DOTh_11515._fields_ = [
    ('_0', struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT0000BEBDOT64DOTh_11515_Sa_0),
]

struct_c__U__SLIST_HEADER_Sa_3._pack_ = True # source:False
struct_c__U__SLIST_HEADER_Sa_3._fields_ = [
    ('HeaderX64', struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT0000BEBDOT64DOTh_11515),
]

class struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10312(ctypes.Structure):
    pass

class struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10312_Sa_0(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
    ('Depth', ctypes.c_uint16, 16),
...
struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10312._pack_ = True # source:False
struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10312._fields_ = [
    ('_0', struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10312_Sa_0),
]
...
class struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10947(ctypes.Structure):
    pass

class struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10947_Sa_0(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
    ('Depth', ctypes.c_uint16, 16),
    ('Sequence', ctypes.c_uint64, 48),
...
struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10947._pack_ = True # source:False
struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10947._fields_ = [
    ('_0', struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10947_Sa_0),
]

union__SLIST_HEADER._pack_ = True # source:True
union__SLIST_HEADER._fields_ = [
    ('_0', struct_c__U__SLIST_HEADER_Sa_0),
    ('Header8', struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10312),
    ('Header16', struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10947),
...
struct_c__S__HEAP_FREE_ENTRY_Ua_Sa_0._pack_ = True # source:False
struct_c__S__HEAP_FREE_ENTRY_Ua_Sa_0._fields_ = [
    ('PreviousBlockPrivateData', ctypes.c_uint64),
...
class union_c__S__HEAP_LOCK_U_Win7SP1X64DOT000143DDOT64DOTh_26738(ctypes.Union):
    _pack_ = True # source:False
    _fields_ = [
    ('CriticalSection', RTL_CRITICAL_SECTION),
     ]
...
__all__ = \
    ...
    'struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10947_Sa_0',
    'INTERLOCK_SEQ', 'PPSLIST_HEADER', 'PHEAP_PSEUDO_TAG_ENTRY',
    'PHEAP_LOCK', 'PPVOID', 'struct_c__S__HEAP_ENTRY_EXTRA_Ua_Sa_1',
    'PVOID32', 'struct__HEAP_LIST_LOOKUP', 'PSINGLE_LIST_ENTRY',
    'struct__HEAP_ENTRY_EXTRA', 'UINT16', 'PHEAP_BUCKET_RUN_INFO',
    'union_c__S__HEAP_USERDATA_HEADER_Ua_0', 'PUSHORT', 'PUCHAR',
    'union_c__S__HEAP_ENTRY_Ua_0', 'HEAP_BUCKET_RUN_INFO',
    ...
    'union__SLIST_HEADER',
    'union_c__S__HEAP_LOCK_U_Win7SP1X64DOT0000BEBDOT64DOTh_22559',
    'PPHEAP_TAG_ENTRY', 'struct_c__S__HEAP_BUCKET_Sa_2',
    'struct__HEAP_SUBSEGMENT', 'DOUBLE',
    ...
    'struct_c__S__HEAP_FREE_ENTRY_Ua_Sa_Ua_Sa_1',
    'struct_c__S__HEAP_FREE_ENTRY_Ua_Sa_Ua_Sa_0', 'PINT8',
    'PPHEAP_ENTRY_EXTRA',
    'struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT0000BEBDOT64DOTh_11515',
    'PPHEAP_SEGMENT', 'struct_c__S__INTERLOCK_SEQ_Ua_Sa_2',
    ...
    'struct__SINGLE_LIST_ENTRY', 'BOOL', 'PPHEAP_LOCAL_DATA',
    'UINT32', 'union_c__S__HEAP_ENTRY_EXTRA_Ua_0', 'HEAP_LOCAL_DATA',
    'PBOOL', 'UCHAR', 'union_c__S__INTERLOCK_SEQ_Ua_0',
    'PHEAP_TUNING_PARAMETERS', 'PPVOID32', 'PVOID64',
    'struct_c__U__HEAP_BUCKET_COUNTERS_Sa_0', 'struct__LIST_ENTRY',
    'struct_c__U__HEAP_BUCKET_COUNTERS_Sa_1', 'PPHEAP_LOOKASIDE',
    ...
    'HEAP_LIST_LOOKUP',
    'union_c__S__HEAP_LOCK_U_Win7SP1X64DOT000143DDOT64DOTh_26738',
    'struct__RTL_CRITICAL_SECTION', 'PPHEAP_BUCKET',
    'union_c__S__HEAP_ENTRY_Ua_Sa_Ua_Sa_Ua_4',
    'PHEAP_LOCAL_SEGMENT_INFO', 'union__HEAP_BUCKET_COUNTERS',
    'PHEAP_LOCAL_DATA', 'CHAR',
    'struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10947',
    'LONG', 'PULONGLONG', 'PLFH_BLOCK_ZONE', 'PPHEAP_BUCKET_COUNTERS',
    'struct__HEAP_BUCKET', 'PSLIST_HEADER',
    'struct__HEAP_UCR_DESCRIPTOR',
    'struct_c__S__HEAP_FREE_ENTRY_Ua_Sa_2',
    ...
    'struct__HEAP_SEGMENT', 'struct__HEAP_VIRTUAL_ALLOC_ENTRY',
    'PPSINGLE_LIST_ENTRY', 'PRTL_CRITICAL_SECTION',
    'PPHEAP_LOCAL_SEGMENT_INFO', 'PPHEAP_FREE_ENTRY',
    'RTL_CRITICAL_SECTION_DEBUG', 'union_c__S__HEAP_SUBSEGMENT_Ua_3',
    'PLFH_HEAP',
    'struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT0000BEBDOT64DOTh_11515_Sa_0',
    'UINT8', 'struct__HEAP_FREE_ENTRY', 'PPHEAP_PSEUDO_TAG_ENTRY',
    'PLONGLONG', 'PPUSER_MEMORY_CACHE_ENTRY', 'PPLFH_BLOCK_ZONE',
    'PHEAP_FREE_ENTRY', 'PPHEAP_LOCK',
    'struct__HEAP_TUNING_PARAMETERS', 'HEAP_TUNING_PARAMETERS',
    'UINT64', 'PPHEAP_SUBSEGMENT', 'LFH_HEAP',
    'struct_c__U__SLIST_HEADER_Sa_0',
    'struct_c__U__SLIST_HEADER_Sa_3', 'PHEAP_BUCKET', 'USHORT',
    'HEAP_ENTRY_EXTRA', 'HEAP_PSEUDO_TAG_ENTRY',
    'union_c__S__HEAP_ENTRY_Ua_Sa_Ua_1', 'PPHEAP', 'HEAP_LOCK',
    'PPINTERLOCK_SEQ', 'LIST_ENTRY', 'USER_MEMORY_CACHE_ENTRY',
    'LFH_BLOCK_ZONE', 'PUINT16', 'PHEAP_UCR_DESCRIPTOR', 'PHEAP',
    'PPVOID64', 'PLIST_ENTRY', 'struct__HEAP_COUNTERS',
    'PHEAP_LIST_LOOKUP', 'PHEAP_SUBSEGMENT', 'HEAP_UCR_DESCRIPTOR',
    'PHEAP_USERDATA_HEADER', 'PHEAP_LOOKASIDE',
    ...
    'struct_c__S__HEAP_SUBSEGMENT_Ua_Sa_0',
    'struct__RTL_CRITICAL_SECTION_DEBUG',
    'struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10312',
    'INT8', 'PCHAR', 'ULONGLONG', 'struct__HEAP_TAG_ENTRY', 'PSHORT',
    'HEAP', 'PHEAP_VIRTUAL_ALLOC_ENTRY', 'PPLFH_HEAP', 'PUINT8',
    'PHEAP_COUNTERS',
    'struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT0000BEBDOT64DOTh_10312_Sa_0',
    ...
    'union_c__S__HEAP_FREE_ENTRY_Ua_0',
    'struct_c__S__HEAP_ENTRY_Ua_Sa_Ua_Sa_1',
