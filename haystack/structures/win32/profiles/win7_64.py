...
class union_c__S__HEAP_LOCK_U_Win7SP1X64DOT0000BEBDOT64DOTh_22528(ctypes.Union):
    pass
...
union_c__S__HEAP_LOCK_U_Win7SP1X64DOT0000BEBDOT64DOTh_22528._pack_ = True # source:False
union_c__S__HEAP_LOCK_U_Win7SP1X64DOT0000BEBDOT64DOTh_22528._fields_ = [
    ('CriticalSection', RTL_CRITICAL_SECTION),
]

struct__HEAP_LOCK._pack_ = True # source:True
struct__HEAP_LOCK._fields_ = [
    ('Lock', union_c__S__HEAP_LOCK_U_Win7SP1X64DOT0000BEBDOT64DOTh_22528),
]
...
class struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT000143DDOT64DOTh_5094(ctypes.Structure):
    pass

class struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT000143DDOT64DOTh_5094_Sa_0(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
...
struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT000143DDOT64DOTh_5094._pack_ = True # source:False
struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT000143DDOT64DOTh_5094._fields_ = [
    ('_0', struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT000143DDOT64DOTh_5094_Sa_0),
]

struct_c__U__SLIST_HEADER_Sa_3._pack_ = True # source:False
struct_c__U__SLIST_HEADER_Sa_3._fields_ = [
    ('HeaderX64', struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT000143DDOT64DOTh_5094),
]

class struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_4526(ctypes.Structure):
    pass

class struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_4526_Sa_0(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
    ('Depth', ctypes.c_uint16, 16),
    ('Sequence', ctypes.c_uint64, 48),
...
struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_4526._pack_ = True # source:False
struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_4526._fields_ = [
    ('_0', struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_4526_Sa_0),
]
...
class struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_3891(ctypes.Structure):
    pass

class struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_3891_Sa_0(ctypes.Structure):
    _pack_ = True # source:False
    _fields_ = [
    ('Depth', ctypes.c_uint16, 16),
...
struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_3891._pack_ = True # source:False
struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_3891._fields_ = [
    ('_0', struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_3891_Sa_0),
]

union__SLIST_HEADER._pack_ = True # source:True
union__SLIST_HEADER._fields_ = [
    ('_0', struct_c__U__SLIST_HEADER_Sa_0),
    ('Header8', struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_3891),
    ('Header16', struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_4526),
    ('_3', struct_c__U__SLIST_HEADER_Sa_3),
]

SLIST_HEADER = union__SLIST_HEADER
struct__HEAP_LOOKASIDE._pack_ = True # source:True
struct__HEAP_LOOKASIDE._fields_ = [
...
struct_c__S__HEAP_FREE_ENTRY_Ua_Sa_2._pack_ = True # source:False
struct_c__S__HEAP_FREE_ENTRY_Ua_Sa_2._fields_ = [
    ('ReservedForAlignment', ctypes.c_uint64),
...
class union_c__S__HEAP_LOCK_U_Win7SP1X64DOT000143DDOT64DOTh_18353(ctypes.Union):
    _pack_ = True # source:False
    _fields_ = [
    ('CriticalSection', RTL_CRITICAL_SECTION),
     ]
...
struct__HEAP_LOCK._pack_ = True # source:True
struct__HEAP_LOCK._fields_ = [
    ('Lock', union_c__S__HEAP_LOCK_U_Win7SP1X64DOT000143DDOT64DOTh_18353),
]
...
__all__ = \
    ['HEAP_VIRTUAL_ALLOC_ENTRY', 'VOID', 'PUINT32',
    'struct__HEAP_USERDATA_HEADER',
    'struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT000143DDOT64DOTh_5094',
    'INTERLOCK_SEQ', 'PPSLIST_HEADER', 'PHEAP_PSEUDO_TAG_ENTRY',
    'PHEAP_LOCK', 'PPVOID', 'struct__HEAP_UCR_DESCRIPTOR',
    'struct_c__S__HEAP_ENTRY_EXTRA_Ua_Sa_1', 'LONG',
    ...
    'struct_c__S__INTERLOCK_SEQ_Ua_Sa_2', 'INT8', 'HEAP_BUCKET',
    ...
    'PPHEAP_ENTRY_EXTRA',
    'union_c__S__HEAP_LOCK_U_Win7SP1X64DOT000143DDOT64DOTh_18353',
    'PPHEAP_SEGMENT', 'PPRTL_CRITICAL_SECTION_DEBUG', 'ULONGLONG',
    ...
    'union_c__S__INTERLOCK_SEQ_Ua_0', 'struct__SINGLE_LIST_ENTRY',
    'PPHEAP', 'PPHEAP_LOCAL_DATA', 'UINT32',
    'union_c__S__HEAP_ENTRY_EXTRA_Ua_0', 'HEAP_LOCAL_DATA', 'PBOOL',
    'UCHAR',
    'struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_3891_Sa_0',
    'PHEAP_TUNING_PARAMETERS', 'PPVOID32',
    'struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_4526_Sa_0',
    'struct_c__U__HEAP_BUCKET_COUNTERS_Sa_0', 'struct__LIST_ENTRY',
    'struct_c__U__HEAP_BUCKET_COUNTERS_Sa_1', 'PSHORT',
    ...
    'PPHEAP_BUCKET', 'union_c__S__HEAP_ENTRY_Ua_Sa_Ua_Sa_Ua_4',
    'PVOID64', 'PHEAP_LOCAL_DATA', 'CHAR',
    'struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_4526',
    'PVOID32', 'PULONGLONG', 'PLFH_BLOCK_ZONE', 'PPSINGLE_LIST_ENTRY',
    ...
    'struct_c__U__SLIST_HEADER_Sa_S_Win7SP1X64DOT000143DDOT64DOTh_5094_Sa_0',
    ...
    'PLFH_HEAP', 'PHEAP_LOCAL_SEGMENT_INFO', 'struct__HEAP_TAG_ENTRY',
    'struct__HEAP_FREE_ENTRY', 'PPHEAP_PSEUDO_TAG_ENTRY', 'PLONGLONG',
    ...
    'LFH_BLOCK_ZONE', 'PUINT16', 'PPHEAP_ENTRY', 'PHEAP', 'PPVOID64',
    'PLIST_ENTRY', 'struct__HEAP_COUNTERS', 'PHEAP_LIST_LOOKUP',
    'PHEAP_SUBSEGMENT',
    'union_c__S__HEAP_LOCK_U_Win7SP1X64DOT0000BEBDOT64DOTh_22528',
    ...
    'struct_c__S__HEAP_ENTRY_Ua_Sa_2', 'PPLIST_ENTRY', 'UINT8',
    'struct__RTL_CRITICAL_SECTION_DEBUG', 'PHEAP_ENTRY_EXTRA',
    'PCHAR', 'union_c__S__HEAP_FREE_ENTRY_Ua_Sa_Ua_Sa_Ua_4',
    'struct__HEAP_SEGMENT', 'PPHEAP_LOOKASIDE', 'HEAP',
    ...
    'HEAP_FREE_ENTRY', 'PHEAP_UCR_DESCRIPTOR',
    ...
    'struct_c__U__SLIST_HEADER_S_Win7SP1X64DOT000143DDOT64DOTh_3891']
