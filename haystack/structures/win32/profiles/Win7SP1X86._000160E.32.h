// Generated by pdbparse v1.1 - -g -w 4 -d heap.structures.win7.1 /home/other/outputs/pdb/Win7SP1X86/_000160E
...
typedef struct _HEAP_LIST_LOOKUP { // 0x24 bytes
	struct _HEAP_LIST_LOOKUP*  ExtendedLookup;        // offset   0x0 size   0x4
	ULONG ArraySize;                                  // offset   0x4 size   0x4
	ULONG ExtraItem;                                  // offset   0x8 size   0x4
	ULONG ItemCount;                                  // offset   0xc size   0x4
	ULONG OutOfRangeItems;                            // offset  0x10 size   0x4
	ULONG BaseIndex;                                  // offset  0x14 size   0x4
	PLIST_ENTRY ListHead;                             // offset  0x18 size   0x4
	PULONG ListsInUseUlong;                           // offset  0x1c size   0x4
	PPLIST_ENTRY ListHints;                           // offset  0x20 size   0x4
...
typedef struct _HEAP_UCR_DESCRIPTOR { // 0x18 bytes
	LIST_ENTRY ListEntry;                             // offset   0x0 size   0x8
	LIST_ENTRY SegmentEntry;                          // offset   0x8 size   0x8
	PVOID Address;                                    // offset  0x10 size   0x4
	ULONG Size;                                       // offset  0x14 size   0x4
...
typedef struct _HEAP_SEGMENT { // 0x40 bytes
	HEAP_ENTRY Entry;                                 // offset   0x0 size   0x8
	ULONG SegmentSignature;                           // offset   0x8 size   0x4
	ULONG SegmentFlags;                               // offset   0xc size   0x4
	LIST_ENTRY SegmentListEntry;                      // offset  0x10 size   0x8
	PHEAP Heap;                                       // offset  0x18 size   0x4
	PVOID BaseAddress;                                // offset  0x1c size   0x4
	ULONG NumberOfPages;                              // offset  0x20 size   0x4
	PHEAP_ENTRY FirstEntry;                           // offset  0x24 size   0x4
	PHEAP_ENTRY LastValidEntry;                       // offset  0x28 size   0x4
