...
class union_c__S__HEAP_LOCK_U_Win7SP1X86DOT32DOTh_10340(ctypes.Union):
    pass
...
union_c__S__HEAP_LOCK_U_Win7SP1X86DOT32DOTh_10340._pack_ = True  # source:False
union_c__S__HEAP_LOCK_U_Win7SP1X86DOT32DOTh_10340._fields_ = [
    ('CriticalSection', RTL_CRITICAL_SECTION),
]

struct__HEAP_LOCK._pack_ = True  # source:True
struct__HEAP_LOCK._fields_ = [
    ('Lock', union_c__S__HEAP_LOCK_U_Win7SP1X86DOT32DOTh_10340),
]
...
__all__ = \
    ['PPHEAP_VIRTUAL_ALLOC_ENTRY', 'HEAP_VIRTUAL_ALLOC_ENTRY', 'VOID',
     ...
     'RTL_CRITICAL_SECTION', 'union__SLIST_HEADER', 'PPHEAP_COUNTERS',
     ...
     'struct__LFH_HEAP', 'union_c__S__HEAP_SUBSEGMENT_Ua_3',
     'struct_c__SA_HEAP_USERDATA_HEADER', 'PINT8',
     'PPHEAP_ENTRY_EXTRA', 'intmax_t', 'int16_t',
     'PPRTL_CRITICAL_SECTION_DEBUG', 'PPHEAP_LIST_LOOKUP',
     ...
     'int_least16_t', 'UINT32', 'uint_least8_t',
     'union_c__S__HEAP_ENTRY_EXTRA_Ua_0', 'HEAP_LOCAL_DATA', 'PBOOL',
     'UCHAR', 'union_c__S__INTERLOCK_SEQ_Ua_0',
     'struct_c__SA_HEAP_LOCK', 'PHEAP_TUNING_PARAMETERS', 'PPVOID32',
     'PVOID64', 'struct__LIST_ENTRY',
     'struct_c__U__HEAP_BUCKET_COUNTERS_Sa_1',
     'struct_c__U__HEAP_BUCKET_COUNTERS_Sa_0', 'uint64_t',
     ...
     'struct__RTL_CRITICAL_SECTION', 'PPHEAP_BUCKET', 'int32_t',
     'uint_least64_t', 'struct_c__S__HEAP_FREE_ENTRY_Ua_Sa_2', 'CHAR',
     'LONG', 'struct_c__SA_HEAP_COUNTERS', 'PULONGLONG',
     'PLFH_BLOCK_ZONE', 'struct__HEAP_LIST_LOOKUP',
     'PPSINGLE_LIST_ENTRY', 'PPHEAP_BUCKET_COUNTERS',
     ...
     'PHEAP_LOCAL_SEGMENT_INFO', 'UINT8', 'int8_t',
     ...
     'LFH_HEAP', 'struct_c__U__SLIST_HEADER_Sa_1', 'PHEAP_BUCKET',
     'USHORT', 'HEAP_ENTRY_EXTRA', 'PPHEAP_SEGMENT',
     'union_c__S__HEAP_ENTRY_Ua_Sa_Ua_2', 'HEAP_PSEUDO_TAG_ENTRY',
     'BOOL', 'HEAP_LOCK', 'PPINTERLOCK_SEQ', 'LIST_ENTRY',
     'USER_MEMORY_CACHE_ENTRY', 'PUINT16', 'PHEAP_UCR_DESCRIPTOR',
     ...
     'struct_c__SA_HEAP',
     'union_c__S__HEAP_LOCK_U_Win7SP1X86DOT32DOTh_10340',
     'union_c__S__HEAP_FREE_ENTRY_Ua_Sa_Ua_2',
     ...
     'uint_fast64_t', 'PHEAP_ENTRY', 'PPHEAP_ENTRY',
     'PPRTL_CRITICAL_SECTION', 'union_c__S__HEAP_FREE_ENTRY_Ua_0',
     'HEAP_LIST_LOOKUP', 'uint32_t', 'PPHEAP_UCR_DESCRIPTOR', 'PVOID',
