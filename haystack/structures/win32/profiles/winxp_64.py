...
class union_c__S__HEAP_LOCK_U_Win2k3_XP64_X64DOTntdllDOT32DOTh_9852(ctypes.Union):
    pass
...
union_c__S__HEAP_LOCK_U_Win2k3_XP64_X64DOTntdllDOT32DOTh_9852._pack_ = True # source:False
...
class union_c__S__HEAP_U_Win2k3_XP64_X64DOTntoskrnlDOT32DOTh_17600(ctypes.Union):
    _pack_ = True # source:False
    _fields_ = [
    ('FreeListsInUseUlong', ctypes.c_uint32 * 4),
    ('FreeListsInUseBytes', ctypes.c_ubyte * 16),
...
class union_c__S__HEAP_U_Win2k3_XP64_X64DOTntoskrnlDOT32DOTh_17797(ctypes.Union):
    _pack_ = True # source:False
    _fields_ = [
    ('FreeListsInUseTerminate', ctypes.c_uint16),
    ('DecommitCount', ctypes.c_uint16),
...
class union_c__S__HEAP_LOCK_U_Win2k3_XP64_X64DOTntoskrnlDOT32DOTh_19030(ctypes.Union):
    _pack_ = True # source:False
    _fields_ = [
    ('CriticalSection', RTL_CRITICAL_SECTION),
    ('Resource', ERESOURCE),
