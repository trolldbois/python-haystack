...
class union_c__S__HEAP_U_WinXPSP3X86DOTntdllDOT32DOTh_14473(ctypes.Union):
...
class union_c__S__HEAP_LOCK_U_WinXPSP3X86DOTntdllDOT32DOTh_10357(ctypes.Union):
    pass
...
union_c__S__HEAP_LOCK_U_WinXPSP3X86DOTntdllDOT32DOTh_10357._pack_ = True # source:False
union_c__S__HEAP_LOCK_U_WinXPSP3X86DOTntdllDOT32DOTh_10357._fields_ = [
...
struct__HEAP_LOCK._fields_ = [
    ('Lock', union_c__S__HEAP_LOCK_U_WinXPSP3X86DOTntdllDOT32DOTh_10357),
]
...
class union_c__S__HEAP_U_WinXPSP3X86DOTntdllDOT32DOTh_14670(ctypes.Union):
    _pack_ = True # source:False
    _fields_ = [
...
struct__HEAP._fields_ = [
    ...
    ('u', union_c__S__HEAP_U_WinXPSP3X86DOTntdllDOT32DOTh_14473),
    ('u2', union_c__S__HEAP_U_WinXPSP3X86DOTntdllDOT32DOTh_14670),
    ('AllocatorBackTraceIndex', ctypes.c_uint16),
...
class union_c__S__HEAP_U_WinXPSP3X86DOTntoskrnlDOT32DOTh_16352(ctypes.Union):
    _pack_ = True # source:False
    _fields_ = [
    ('FreeListsInUseUlong', ctypes.c_uint32 * 4),
    ('FreeListsInUseBytes', ctypes.c_ubyte * 16),
...
class union_c__S__HEAP_U_WinXPSP3X86DOTntoskrnlDOT32DOTh_16549(ctypes.Union):
    _pack_ = True # source:False
    _fields_ = [
    ('FreeListsInUseTerminate', ctypes.c_uint16),
    ('DecommitCount', ctypes.c_uint16),
...
class union_c__S__HEAP_LOCK_U_WinXPSP3X86DOTntoskrnlDOT32DOTh_17700(ctypes.Union):
    _pack_ = True # source:False
    _fields_ = [
    ('CriticalSection', RTL_CRITICAL_SECTION),
    ('Resource', ERESOURCE),
...
__all__ = \
    ['PPHEAP_UNCOMMMTTED_RANGE',
    'union_c__S__HEAP_U_WinXPSP3X86DOTntoskrnlDOT32DOTh_16549',
    'HEAP_VIRTUAL_ALLOC_ENTRY', 'VOID', 'HEAP_FREE_ENTRY', 'PUINT32',
    'struct__HEAP_USERDATA_HEADER',
    'union_c__S__HEAP_U_WinXPSP3X86DOTntoskrnlDOT32DOTh_16352',
    'INTERLOCK_SEQ', 'PPSLIST_HEADER', 'struct__DISPATCHER_HEADER',
    'PHEAP_PSEUDO_TAG_ENTRY', 'PHEAP_LOCK',
    'union_c__S__ERESOURCE_Ua_10', 'PPVOID', 'PVOID32',
    'PSINGLE_LIST_ENTRY', 'struct__HEAP_ENTRY_EXTRA', 'UINT16',
    ...
    'struct__OWNER_ENTRY', 'HEAP_TAG_ENTRY', 'HEAP_ENTRY',
    'struct_c__S__HEAP_SUBSEGMENT_Ua_Sa_0', 'RTL_CRITICAL_SECTION',
    'union__SLIST_HEADER', 'PPOWNER_ENTRY', 'PPHEAP_TAG_ENTRY',
    ...
    'PINT8', 'KSEMAPHORE', 'PPHEAP_SEGMENT',
    'struct_c__S__INTERLOCK_SEQ_Ua_Sa_2',
    'union_c__S__HEAP_LOCK_U_WinXPSP3X86DOTntdllDOT32DOTh_10357',
    'union_c__S__HEAP_FREE_ENTRY_Ua_0', 'HEAP_SUBSEGMENT',
    'ERESOURCE', 'ULONG', 'struct__HEAP', 'HEAP_USERDATA_HEADER',
    'HEAP_LOOKASIDE', 'struct__KSEMAPHORE', 'struct__INTERLOCK_SEQ',
    'struct__HEAP_LOCK', 'struct__SINGLE_LIST_ENTRY', 'BOOL',
    'struct__ERESOURCE', 'UINT32',
    'union_c__S__HEAP_ENTRY_EXTRA_Ua_0', 'PBOOL', 'UCHAR',
    'union_c__S__INTERLOCK_SEQ_Ua_0', 'PPVOID32', 'PVOID64',
    'PHEAP_TAG_ENTRY', 'struct__LIST_ENTRY', 'OWNER_ENTRY',
    'PPHEAP_LOOKASIDE', 'union_c__S__OWNER_ENTRY_Ua_1',
    'PDISPATCHER_HEADER', 'HEAP_SEGMENT', 'PULONG', 'WCHAR',
    'PHEAP_ENTRY', 'PPERESOURCE', 'struct__RTL_CRITICAL_SECTION',
    'CHAR', 'LONG', 'PULONGLONG', 'HEAP_UCR_SEGMENT', 'PSLIST_HEADER',
    ...
    'PHEAP_UNCOMMMTTED_RANGE', 'struct__HEAP_SEGMENT', 'KEVENT',
    'struct__HEAP_VIRTUAL_ALLOC_ENTRY', 'PPSINGLE_LIST_ENTRY',
    'PRTL_CRITICAL_SECTION', 'PPHEAP_FREE_ENTRY',
    'RTL_CRITICAL_SECTION_DEBUG', 'UINT8', 'struct__HEAP_FREE_ENTRY',
    'PPHEAP_PSEUDO_TAG_ENTRY', 'PLONGLONG', 'PERESOURCE',
    'DISPATCHER_HEADER', 'PPHEAP_ENTRY_EXTRA', 'PHEAP_FREE_ENTRY',
    'PPHEAP_LOCK', 'struct_c__S__HEAP_ENTRY_EXTRA_Ua_Sa_1', 'UINT64',
    'PPHEAP_SUBSEGMENT', 'struct_c__U__SLIST_HEADER_Sa_1',
    'struct__KEVENT', 'USHORT', 'HEAP_ENTRY_EXTRA',
    'HEAP_PSEUDO_TAG_ENTRY', 'PPHEAP', 'HEAP_LOCK',
    'union_c__S__HEAP_U_WinXPSP3X86DOTntdllDOT32DOTh_14670',
    'PPINTERLOCK_SEQ', 'struct__HEAP_UCR_SEGMENT', 'LIST_ENTRY',
    'PUINT16', 'PHEAP', 'PPVOID64', 'PLIST_ENTRY', 'PKEVENT',
    'PHEAP_SUBSEGMENT', 'PPLIST_ENTRY', 'PHEAP_LOOKASIDE',
    'struct_c__S__HEAP_ENTRY_Ua_Sa_1',
    'struct_c__S__HEAP_ENTRY_Ua_Sa_0',
    'union_c__S__HEAP_LOCK_U_WinXPSP3X86DOTntoskrnlDOT32DOTh_17700',
    'PHEAP_USERDATA_HEADER', 'POWNER_ENTRY',
    'union_c__S__HEAP_U_WinXPSP3X86DOTntdllDOT32DOTh_14473',
    'PHEAP_UCR_SEGMENT', 'struct__RTL_CRITICAL_SECTION_DEBUG', 'INT8',
    'PCHAR', 'ULONGLONG', 'PPHEAP_UCR_SEGMENT',
    'struct__HEAP_TAG_ENTRY', 'PSHORT', 'PPKEVENT',
    'PPHEAP_USERDATA_HEADER', 'HEAP', 'PHEAP_VIRTUAL_ALLOC_ENTRY',
    'PUINT8', 'SINGLE_LIST_ENTRY',
